        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  TextComponent(text: widget.cardName, style: 'cardTitle')
                ],
              ),
              Row(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Row(
                        children: [
                          TextComponent(text: widget.cardNumFinal.isNotEmpty ? "Final " : "", style: 'cardVenc'),
                          TextComponent(text: widget.cardNumFinal.isNotEmpty ? widget.cardNumFinal : "", style: 'cardNumVenc')
                        ],
                      ),
                    ],
                  ),
