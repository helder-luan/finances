...
class _DetalhesCartaoState extends State<DetalhesCartao> {
  ...
  Future loadAll() async {
    await loadHistorico().then((value) => calculaValorFatura());
    await loadTipoOperacao();
  }

  Future calculaValorFatura() async {
    faturaTotal = historico.fold(0.0, (previousValue, transacao) => previousValue + Functions.formataValor(transacao.valor.toString())!);
  }
